...
export const metadata = {
  ...
  description:
    "Book professional mobile, tablet, and laptop repairs at OM Mobile Repair Center. Fast turnaround, genuine parts, certified technicians, and 1-year warranty on all repairs.",
  keywords: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-8">
                With 10+ years in the device repair industry, we've built a
